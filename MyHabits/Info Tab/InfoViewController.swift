...
private extension InfoViewController {
    func setupLayout() {
        let constraints = [
            ...
            infoDescription.trailingAnchor.constraint(equalTo: scrollView.trailingAnchor, constant: -16),
            infoDescription.leadingAnchor.constraint(equalTo: scrollView.leadingAnchor, constant: 16),
            infoDescription.bottomAnchor.constraint(equalTo: scrollView.bottomAnchor),
